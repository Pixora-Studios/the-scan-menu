    ...
    <div className="min-h-screen bg-[#F9FAFB] font-sans">
      ...
      <header className="bg-white border-b border-slate-100 px-6 py-4 flex items-center justify-between">
        <h1 className="font-display tracking-tight text-3xl font-semibold text-slate-900">
          Pixora QR <span className="text-xs font-sans px-2 py-0.5 bg-amber-100 text-amber-800 rounded font-medium">Phase 1 Dev</span>
        </h1>
        <button
          onClick={logout}
          ...
          <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                This is a secure placeholder shell. Subsequent development phases (Phases 2-12) will construct operations menus, ordering workflows, live dashboards, and branding configurations here.
              </p>
            </div>
          </div>
        </motion.div>
